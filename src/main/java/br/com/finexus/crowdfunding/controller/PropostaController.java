...
public ResponseEntity<?> criarProposta(@RequestBody Proposta proposta) {
    ...
    if (formularioOpt.isEmpty()) {
        return ResponseEntity.badRequest().body("É necessário preencher o formulário de risco antes de criar uma proposta.");
    }
    ...
    public ResponseEntity<?> atualizarStatus(@PathVariable Long id, @RequestParam StatusProposta status) {
        ...
        // 🔍 Verifica risco antes de aprovar
